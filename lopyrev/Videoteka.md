...
Жанры:
INSERT INTO genres (genre_name) VALUES ('Драма'), ('Комедия'), ('Ужасы'), ('Боевик'), ('Фантастика'), ('Триллер'), ('Мелодрама'), ('Детектив'), 
('Мультфильм'), ('Фэнтези'), ('Приключения'), ('Исторический'), ('Криминал'), ('Биография'), ('Вестерн');
