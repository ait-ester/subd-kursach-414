...
### Создание требований к архитектуре БД домашней библиотеки 
...
2.5.1. Данные о литературных произведениях.
...
3.4.2. Дата поступления в библиотеку;

3.4.3. Оценочная стоимость экземпляра;

3.4.4. Физическое состояние (отличное, хорошее, удовлетворительное, плохое);

3.4.5. Особые отметки (автограф автора, повреждения).
