...
4. [Логическая структура БД](#logical-structure)
5. [Физическая структура базы данных](#physical-structure)
6. [Реализация проекта в среде конкретной СУБД](#implementation)
...
## <p align="center"> <a id="theory"> Основная часть </a>

###  <a id="list_of_sw"> Перечень используемого ПО при разработке. </a>
...
### Требования к архитектуре БД домашней библиотеки 
...
## <p align = "center"> Инфологическая (концептулаьная) модель базы данных
