...
2. Анализ предметной области. 
    ...
    2.2. Перечень входных данных.

    2.3. Перечень выходных данных

    2.4. Ограничения предметной области (если таковые имеются).

    2.5. Взаимодействие с другими программами.
