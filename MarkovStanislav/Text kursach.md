...
<ul>
  ...
  <li>
    ...
    <ul>
      ...
      <li><a href="#55-Приложение-A">5.5. Приложение A</a></li>
      <li><a href="#55-Приложение-B">5.5. Приложение B</a></li>
    </ul>
  </li>
...
<p>
Целью данной курсовой работы является проектирование и реализация
базы данных и клиентского настольного приложения для учёта личных финансов
с использованием СУБД PostgreSQL и технологии JDBC.
</p>
...
Разрабатываемая система предназначена для хранения и просмотра данных о доходах,
расходах.
</p>
...
создания программного приложения.
</p>

<p>
Ведение учёта домашних финансов позволяет пользователям получить
...
<ul>
  ...
  <li>данные об операциях в виде CSV-файла</li>
</ul>

<p>
Выходные данные формируются на основе информации, хранящейся в базе данных,
и предоставляются пользователю в виде выборок и аналитических данных.
Они позволяют оценить текущее финансовое состояние и структуру расходов и доходов.
</p>

<p>
К числу выходных данных относятся данные об операциях, доходы и расходы, сводные данные 
по категориям, а также показатели, такие как сумма доходов и расходов.
</p>
...
<p>
База данных может быть интегрирована с настольным приложением,
разработанным с использованием современных средств программирования.
...
<p>Кроме базовых таблиц, в логической структуре базы данных предусмотрены
вспомогательные объекты: представление для получения агрегированных данных 
об операциях и хранимая процедура для централизованного добавления финансовых операций.</p>
...
настольного для учёта домашних финансов, а также послужить
